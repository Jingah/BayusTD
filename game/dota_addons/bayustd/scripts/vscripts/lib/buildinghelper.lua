...
function BuildingHelper:Init()
    ...
    -- Lua Modifiers
    LinkLuaModifier("modifier_building", "lib/modifiers/modifier_building", LUA_MODIFIER_MOTION_NONE)
    LinkLuaModifier("modifier_out_of_world", "lib/modifiers/modifier_out_of_world", LUA_MODIFIER_MOTION_NONE)
    LinkLuaModifier("modifier_builder_hidden", "lib/modifiers/modifier_builder_hidden", LUA_MODIFIER_MOTION_NONE)
    LinkLuaModifier("modifier_repairing", "lib/modifiers/repair_modifiers", LUA_MODIFIER_MOTION_NONE)
    LinkLuaModifier("modifier_builder_repairing", "lib/modifiers/repair_modifiers", LUA_MODIFIER_MOTION_NONE)
    LinkLuaModifier("modifier_tree_cut", "lib/modifiers/modifier_tree_cut", LUA_MODIFIER_MOTION_NONE)
    require("lib/modifiers/grid_modifiers")
